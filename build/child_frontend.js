...
var $j = jquery__WEBPACK_IMPORTED_MODULE_1___default.a.noConflict(); // Additional head CSS files for cssVars ponyfill

window.additionalCssIncludes = window.additionalCssIncludes || [];
window.additionalCssIncludes.push('link#' + window.CHILD_PREFIX + '_style-css');
...
(function ($, window, undefined) {
  $(function () {
    ...
    $('body').click(function (e) {
      if (window.tgmp && e.target.is('.tgmp_onair, .tgmp_onair a')) {
        e.preventDefault();
        window.tgmp.onair();
      }
    });
...
/******/ });
//# sourceMappingURL=child_frontend.js.map